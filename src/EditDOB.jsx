    ...
    return(
        <Box textAlign='center' sx={{
          ...
          <Form.Group id="newDOB">
            <StyledTextField label="Date of Birth" variant="filled" type="newDOB" inputRef={newDOB} required></StyledTextField>
          </Form.Group>

          <ThemeProvider theme={defaultButton}>
         <Button sx={{ width: 400 }} variant="contained" id = "SubmitDOB" type = "submit">
           Update
         </Button>
       </ThemeProvider>
          </Form>
